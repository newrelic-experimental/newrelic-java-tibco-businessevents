...
# New Relic Java Instrumentation for Tibco BusinessEvents

Provides instrumentation for Tibco Business Events 5.x.

## Installation

To install the New Relic Java Agent on Tibco BusinessEvents see [Install Java Agent](./Install-Java-Agent.md).  
...
## License
Instrumentation for Tibco BusinessEvents 5.x is licensed under the [Apache 2.0](http://apache.org/licenses/LICENSE-2.0.txt) License.
